...
export async function createShiprocketOrder(
  ...
  try {
    console.log('🚀 [Client] Creating Shiprocket order');

    // Step 1: Get authentication token
    console.log('📡 [Client] Fetching auth token...');
    ...
    console.log('✅ [Client] Auth token received');

    // Step 2: Create order
    console.log('📦 [Client] Creating order...');
    ...
    console.log('✅ [Client] Order created:', orderData);
