...
export default function Sidebar() {
  ...
  return (
    <div className="flex flex-col w-full sm:w-56 md:w-64 bg-white text-black shadow-lg lg:fixed lg:top-0 lg:left-0 lg:bottom-0 h-screen lg:h-full">
      {/* Logo */}
      <div className="flex items-center justify-center h-20 sm:h-24 md:h-28 shrink-0">
      ...
      {/* Back to Home */}
      <div className="px-3 sm:px-4 md:px-6 py-4 sm:py-5 md:py-6 border-t border-gray-300 shrink-0">
        <Link
          href="/"
