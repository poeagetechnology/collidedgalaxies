...
export const ProductTable: React.FC<ProductTableProps> = ({
  ...
  return (
    <div>
      <table className="w-full bg-white border border-collapse border-gray-200 shadow-md table-fixed">
              ...
              <td className="py-2 px-2 sm:px-4 border border-gray-300">
                <div className="flex gap-1 sm:gap-2 items-center">
                  <button
                    ...
                    className="bg-blue-500 hover:bg-blue-600 text-white p-1 rounded-sm flex items-center justify-center"
                  >
                    <Edit size={14} />
                  </button>
                  <button
                    ...
                    className="bg-red-500 hover:bg-red-600 text-white p-1 rounded-sm flex items-center justify-center"
                  >
                    <Trash2 size={14} />
                  </button>
                </div>
