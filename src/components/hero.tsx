...
export default function HeroSection() {
  ...
  return (
    <section className="w-full min-h-screen bg-gradient-to-b from-white to-gray-50 flex items-center justify-center py-2 md:py-4">
                  ...
                  >
                    ...
                    >
                      <Link
                        ...
                        className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-full text-base font-bold hover:from-gray-800 hover:to-gray-700 transition-all duration-300 whitespace-nowrap shadow-lg"
                      >
                        <span>Buy Now</span>
