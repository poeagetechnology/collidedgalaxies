        ...
        <div className="space-y-4">
          ...
          <div>
            <select
              ...
              className="w-full px-4 text-sm py-2.5 h-10 border font-medium border-black focus:outline-none focus:ring-2 focus:ring-black bg-white appearance-none cursor-pointer"
              style={{
          ...
          <div>
            <input type="text" name="address" value={formData.address} onChange={handleChange} placeholder="Address *" className="w-full px-4 py-2.5 border h-9 border-black focus:outline-none focus:ring-2 focus:ring-black" />
            <p className="text-xs ml-4 text-gray-500 mt-1">E.g. 3 Stripes Street, Building Name</p>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <input type="text" name="postalCode" value={formData.postalCode} onChange={handleChange} placeholder="Postal Code *" maxLength={10} className="w-1/2 px-4 py-2.5 border h-10 border-black focus:outline-none focus:ring-2 focus:ring-black" />
          </div>
