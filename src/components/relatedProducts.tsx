                  ...
                  >
                    <Link href={`/pdtDetails/${product.slug || product.id}`}>
                      <div className="bg-white rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 cursor-pointer h-full flex flex-col">
                        {/* Image Container */}
                        <div className="relative w-full aspect-3/4 bg-gray-200 overflow-hidden rounded-t-lg">
                          <Image
                            src={productImage}
                            alt={product.title}
                            fill
                        ...
                        <div className="p-4 flex-1 flex flex-col justify-between">
                          ...
                          <div>
                            ...
                            <button 
                              ...
                              className="w-full bg-black text-white py-2 px-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-gray-900 transition-colors text-sm"
                            >
                              <ShoppingBag size={16} />
                              Add to Cart
                            </button>
