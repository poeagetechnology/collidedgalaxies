...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We accept all major debit/credit cards, UPI apps (Google Pay, PhonePe, Paytm), and net banking. All payments are securely processed through Razorpay Payment Gateway.",
  },
];
